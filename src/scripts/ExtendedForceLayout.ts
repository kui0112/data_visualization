...
import type {
    ...
    OutNode,
    Point,
} from '@antv/layout/lib/types';
import {formatNumberFn, isArray} from '@antv/layout/lib/util';
import {forceNBody} from '@antv/layout/lib/force/forceNBody';
import {
    CalcEdge,
    CalcEdgeData,
    CalcGraph,
    ...
    CalcNodeData,
    FormatedOptions,
} from '@antv/layout/lib/force/types';
 ...
 */
export class ExtendedForceLayout implements LayoutWithIterations<ForceLayoutOptions> {
    id = 'extended-force';
    /**
