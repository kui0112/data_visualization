...
export class MixedNode extends BaseNode {
    ...
    public constructor(options: DisplayObjectConfig<MixedNodeStyleProps>) {
        ...
        this.context.graph.on("NewGraph:Initialize", (e) => {
            this.keyOpacity = 0
            this.imageOpacity = 0
            this.disappear = false
            this.imageMode = false
        ...
        this.context.graph.on("NewGraph:EnterTextState", (e) => {
        ...
        this.context.graph.on("NewGraph:EnterImageState", (e) => {
            if (this.disappear) return;
            if (!this.imageMode) {
                this.imageOpacity = 0
                this.keyOpacity = 0
        ...
        this.context.graph.on("NewGraph:Disappear", (e) => {
            this.disappear = true
        })
        ...
        this.context.graph.on("MixedNode:emergeEnd", (e) => {
            if (this.isLeaf) {
                this.emergeEnd = true
            }
        })
